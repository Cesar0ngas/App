...
if page == "Welcome":
    ...
    st.write("Aquí podrás analizar la interacción de los usuarios de Instagram en base a sus publicaciones.")

    # Botón para cargar datos y barra de progreso
    if st.button("Load Data") or st.session_state.get("data_loaded", False):
